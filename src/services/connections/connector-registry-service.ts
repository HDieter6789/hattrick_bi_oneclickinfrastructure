...
const CATEGORY_BY_CONNECTOR_TYPE: Record<string, ConnectorCategory> = {
  // Verified against a live tenant's supportedConnectionTypes response —
  // see the doc comment on prisma/seed/connectors.ts for details on which
  // of these differ from older Power Query/Data Factory naming.
  SQL: "databases",
  AzureSqlMI: "databases",
  OneLakeFile: "microsoft",
  OneLakeSql: "microsoft",
  ...
  AzureBlobs: "cloud_storage",
  AmazonS3: "cloud_storage",
  GoogleCloudStorage: "cloud_storage",
  Salesforce: "saas",
  SalesforceServiceCloud: "saas",
  SalesforceData360: "saas",
  ServiceNow: "saas",
  AzureFiles: "files",
  FTP: "files",
  SFTP: "files",
  ...
  SAPTableApplicationServer: "erp",
  SAPTableMessageServer: "erp",
  SAPBWOpenHubApplicationServer: "erp",
  SAPBWOpenHubMessageServer: "erp",
  SAPBusinessDataCloud: "erp",
};
